...
<span style="font-family: Segoe UI;font-size: 10pt">Consider a scenario, where a client browser is accessing the site  <a href="https://www.kaushalz.com">https://www.kaushalz.com</a>. </span>
...
<ul style="margin-left: 39pt">
  ...
  <li>
    ...
    <div>
      <span style="font-family: Segoe UI;font-size: 10pt">The Client typically selects the most secure protocol version and sends it to the server. Below is a snippet from the <a href="http://tools.ietf.org/html/rfc3546"><strong>RFC 3546</strong></a>: </span>
    </div>
      ...
      <br/>
If you were to capture a network trace (or a TCP Dump) this is how the <strong>CLIENT HELLO</strong> would look like:
      <div style="margin-left: 10pt">
        <table style="background-color:#e6e6e6;font-family: consolas; font-size:11pt; color:black;width: 650px">
              ...
              <td style="padding-left: 9px;padding-right: 9px;border: solid 0.5pt">
                ...
                <p>
                  ...
                  <p style="margin-left: 39pt">
                    ...
                    <p style="text-align: left;margin:10 pt">
